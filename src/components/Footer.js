    ...
    <footer className="bottom  w-100 mt-auto bg-dark p-4">
      <div className="container text-center mb-3">
        ...
        <h4 className="text-white text-deco">
          ...
          <a
            href='mailto:ikubiti@icloud.com'
            rel='noopener noreferrer'
          ><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-envelope-at-fill" viewBox="0 0 16 16">
